...
spiny_counts |>
ggplot(aes(x = counts, y = reef, color = mpa)) +
...
In OLS there is an assumption of normality of residuals. In the case of the the qq plot, ideally we would like to see the points fall along the line, since we are seeing a curve it means that our data is violating the assumption of normality.
